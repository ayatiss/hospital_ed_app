...
from app.schemas.user_schemas import CreateNurseSchema, CreateDoctorSchema, CreateReceptionistSchema, UserResponseSchema

router = APIRouter()

# Admin: Create nurse
@router.post("/create-nurse", response_model=UserResponseSchema)
...
# Admin: Create doctor
@router.post("/create-doctor", response_model=UserResponseSchema)
...
@router.post("/create-receptionist", response_model=UserResponseSchema)
